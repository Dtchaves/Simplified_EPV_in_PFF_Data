...
class TrainerPassSucess:
    ...
    def run(self):
        ...
        if best_model is None:
            raise RuntimeError("Could not train Pass_success_probability model.")
...
class TrainerConfig:
    ...
    model: SoccerMapPassSucess =  field(default_factory=lambda:SoccerMapPassSucess(in_channels=13))
